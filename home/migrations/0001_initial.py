    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ratings', models.DecimalField(decimal_places=0, default=0, max_digits=1)),
                ('discount', models.ForeignKey(blank=True, null=True, on_delete='item', related_name='no', to='home.Discount')),
            ],
        ),
        migrations.CreateModel(
            name='ItemType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=150)),
                ('url', models.URLField()),
                ('category', models.ForeignKey(on_delete='submenu', related_name='yes', to='home.Categories')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='itemtype',
            name='submenu',
            field=models.ForeignKey(blank=True, null=True, on_delete='Itemtype', related_name='yes', to='home.Submenu'),
        ),
        migrations.AddField(
            model_name='item',
            name='producttype',
            field=models.ForeignKey(blank=True, null=True, on_delete='itemtype', related_name='yes', to='home.ItemType'),
        ),
        migrations.AddField(
            model_name='item',
            name='promocategory',
            field=models.ForeignKey(blank=True, null=True, on_delete='item', related_name='yes', to='home.Promo'),
        ),
        migrations.AddField(
            model_name='item',
            name='submenu',
            field=models.ForeignKey(on_delete='item', related_name='no', to='home.Submenu'),
        ),
    ]
